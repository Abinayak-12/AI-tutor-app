  ...
  return (
    <footer className="bg-slate-900 text-slate-300 py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-12 mb-12 border-b border-slate-800 pb-12">
          <div className="col-span-2">
            ...
            <p className="max-w-xs text-slate-400 leading-relaxed">
              Empowering the next generation of learners through personalized AI academic support.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm">
              ...
              <li><a href="#" className="hover:text-indigo-400 transition-colors">Desktop App</a></li>
            </ul>
          </div>
